...
nice ionice docker run --rm --user "$(id -u):$(id -g)" \
  ...
  librelane --manual-pdk --pdk-root /home/matthias/.ciel/ihp-sg13g2 --pdk ihp-sg13g2 --run-tag sys5ns_u45 ../librelane.json > librelane_sys5ns_u45.log 2>&1
echo "librelane exit $? $(date)" >> librelane_sys5ns_u45.log
