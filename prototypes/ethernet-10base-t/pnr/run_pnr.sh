...
nice ionice docker run --rm --user "$(id -u):$(id -g)" \
  ...
  librelane --manual-pdk --pdk-root /home/matthias/.ciel/ihp-sg13g2 --pdk ihp-sg13g2 --run-tag eth60 ../librelane.json > librelane_eth60.log 2>&1
echo "librelane exit $? $(date)" >> librelane_eth60.log
