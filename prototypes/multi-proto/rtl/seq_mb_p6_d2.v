module deadline_sequencer_mb_p6_d2 (
    port_out_ready,
    flags,
    pin_in,
    host_in,
    ...
    assign _173 = 6'b000000;
    assign _686 = _655 ? _656 : _631;
    assign _685 = _596 == _203;
    assign _687 = _685 ? _633 : _686;
    assign _681 = 12'b000000000000;
    assign _682 = _387 == _681;
    assign _683 = _682 ? _633 : _631;
    ...
    assign _676 = _358 == _681;
    assign _677 = ~ _676;
    assign _678 = _677 ? _656 : _633;
    assign _673 = host_in_valid ? _633 : _631;
    assign _667 = _655 ? _656 : _631;
    assign _668 = _102 ? _633 : _667;
    assign _665 = _655 ? _656 : _631;
    assign _666 = _558 ? _633 : _665;
    assign _669 = _96 ? _668 : _666;
    assign _662 = _655 ? _656 : _631;
    ...
    assign _663 = _122 ? _633 : _662;
    assign _660 = _655 ? _656 : _631;
    assign _661 = _535 ? _633 : _660;
    assign _664 = _96 ? _663 : _661;
    assign _670 = _95 ? _669 : _664;
    assign _656 = imem_data[5:0];
    ...
    assign _655 = _387 == _681;
    assign _657 = _655 ? _656 : _631;
    assign _652 = imem_data[11:11];
    assign _650 = flags[3:3];
    assign _649 = flags[2:2];
    assign _648 = flags[1:1];
    assign _647 = flags[0:0];
    assign _646 = _529[3:3];
    assign _645 = _529[2:2];
    assign _644 = _529[1:1];
    assign _643 = _529[0:0];
    assign _642 = _158[7:7];
    assign _641 = _158[6:6];
    assign _640 = _158[5:5];
    assign _639 = _158[4:4];
    assign _638 = _158[3:3];
    assign _637 = _158[2:2];
    assign _636 = _158[1:1];
    ...
    assign _611 = imem_data[7:0];
    assign _606 = _158[6:0];
    assign _608 = { _606,
                    _184 };
    assign _604 = _158[7:1];
    assign _605 = { _184,
                    _604 };
    assign _609 = _203 ? _608 : _605;
    ...
    assign _610 = _571 ? _609 : _602;
    assign _569 = 4'b0100;
    assign _570 = _91 == _569;
    assign _612 = _570 ? _611 : _610;
    assign _60 = _612;
    assign _613 = _368 ? _60 : _148;
    assign _61 = _613;
    always @(posedge clock) begin
        if (clear)
            _148 <= _141;
    ...
    assign _635 = _158[0:0];
    assign _634 = imem_data[10:7];
    always @* begin
        case (_634)
        0:
            _651 <= _635;
    ...
    assign _653 = _651 == _652;
    assign _658 = _653 ? _633 : _657;
    assign _632 = 6'b000001;
    assign _333 = _145 == _103;
    assign _614 = _333 ? _66 : _165;
    assign _62 = _614;
    always @(posedge clock) begin
        if (clear)
            _165 <= _173;
    ...
    assign _629 = 4'b1111;
    assign _630 = _91 == _629;
    assign _659 = _630 ? _658 : _633;
    assign _92 = 4'b1110;
    assign _628 = _91 == _92;
    assign _671 = _628 ? _670 : _659;
    assign _626 = 4'b1101;
    assign _627 = _91 == _626;
    assign _672 = _627 ? _631 : _671;
    assign _176 = 4'b1100;
    assign _625 = _91 == _176;
    assign _674 = _625 ? _673 : _672;
    assign _623 = 4'b1010;
    assign _624 = _91 == _623;
    assign _679 = _624 ? _678 : _674;
    assign _621 = 4'b1001;
    assign _622 = _91 == _621;
    assign _680 = _622 ? _656 : _679;
    assign _619 = 4'b0110;
    assign _620 = _91 == _619;
    assign _684 = _620 ? _683 : _680;
    assign _617 = 4'b0101;
    assign _91 = imem_data[15:12];
    assign _618 = _91 == _617;
    assign _688 = _618 ? _687 : _684;
    assign _66 = _688;
    assign _368 = _145 == _109;
    assign _689 = _368 ? _66 : _174;
    assign _67 = _689;
    always @(posedge clock) begin
        if (clear)
            _174 <= _173;
    ...
    assign _693 = _145 + _107;
    assign _695 = { _693,
                    _694 };
    assign imem_addr = _695;
    assign pin_out = _254;
    assign pin_oe = _197;
