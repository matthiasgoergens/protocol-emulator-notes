# Four-phase clock SDC, core period = 18.8 ns (53.1915 MHz)
...
create_clock -name ph0 -period 18.8 -waveform {0 9.400000} [get_ports ph0]
create_clock -name ph1 -period 18.8 -waveform {4.700000 14.100000} [get_ports ph1]
create_clock -name ph2 -period 18.8 -waveform {9.400000 18.800000} [get_ports ph2]
create_clock -name ph3 -period 18.8 -waveform {14.100000 23.500000} [get_ports ph3]
