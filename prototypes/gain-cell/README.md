...
| PMOS storage transistor in an n-well | a written 1 (0.59–0.80 V) never turns it off: needs ≥ 0.77–1.0 V (`read-plv-bar1.2.txt`); the 0 rises 0.3 V in 100 µs at tt/27 °C (`hold-plv-bar1.2.txt`) | 2.65 µm², drawn, DRC-clean | no |
