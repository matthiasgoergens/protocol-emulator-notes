...
type t = {
  ...
  imem_data : Bits.t ref; pin_in : Bits.t ref; pin_in4 : Bits.t ref; host_in : Bits.t ref; host_in_valid : Bits.t ref; clear : Bits.t ref;
  imem_addr : Bits.t ref; pin_out : Bits.t ref; pin_oe : Bits.t ref; host_out : Bits.t ref;
  host_out_valid : Bits.t ref; host_in_ready : Bits.t ref; pcs : Bits.t ref; pin_sub : Bits.t ref;
...
let make mem =
  ...
  let s = { sim; mem; imem_data = i "imem_data"; pin_in = i "pin_in"; pin_in4 = i "pin_in4"; host_in = i "host_in";
            host_in_valid = i "host_in_valid"; clear = i "clear"; imem_addr = o "imem_addr";
            pin_out = o "pin_out"; pin_oe = o "pin_oe"; host_out = o "host_out";
            host_out_valid = o "host_out_valid"; host_in_ready = o "host_in_ready"; pcs = o "pcs"; pin_sub = o "pin_sub";
...
(* [pin_in4]: the four quarter-clock samples per pin (bit 4i+p); by default all four equal pin_in *)
let cycle ?pin_in4 s ~pin_in ~host_in ~host_in_valid =
  let pin_in4 = match pin_in4 with Some v -> v | None -> Isa.replicate4 pin_in in
  s.pin_in4 := Bits.of_int ~width:32 pin_in4;
